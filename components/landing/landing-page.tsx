...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    quote: 'Switched from Gmail and never looked back. The keyboard shortcuts alone saved me hours a week.',
  },
  {
    name: 'Priya Nair',
    ...
    quote: 'Managing investor emails used to be chaos. ZenMail turned it into a superpower.',
  },
];
          ...
          <div className="landing-logo">
            <div className="landing-logo-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M2 6L12 13L22 6" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
              </svg>
            </div>
      ...
      <section className="landing-hero">
        ...
        <div className="landing-hero-inner">
          ...
          <p className="landing-hero-sub">
            ZenMail is a minimal, blazing-fast email client built for people who value focus.
            No clutter. No noise. Just your inbox, beautifully organized.
          </p>
          ...
          <div className="landing-preview">
            ...
            <div className="landing-preview-body">
              <div className="landing-preview-sidebar">
                {['Inbox', 'Starred', 'Sent', 'Drafts', 'Archive'].map((f, i) => (
                  <div key={f} className={`landing-preview-folder ${i === 0 ? 'active' : ''}`}>
                    <span className="landing-preview-folder-dot" style={{ opacity: i === 0 ? 1 : 0.4 }} />
                    {f}
                  </div>
                ))}
              </div>
              <div className="landing-preview-list">
                {[
                  { from: 'Sarah K.', subj: 'Design review tomorrow ✓', time: '9:41 AM', unread: true },
                  { from: 'GitHub', subj: 'PR #142 merged successfully', time: '8:15 AM', unread: false },
                  { from: 'Liam T.', subj: 'Let\'s sync on the Q3 roadmap', time: 'Yesterday', unread: true },
                  { from: 'Notion', subj: 'Your weekly digest is ready', time: 'Yesterday', unread: false },
                ].map((email, i) => (
                  <div key={i} className={`landing-preview-email ${email.unread ? 'unread' : ''}`}>
                    <div className="landing-preview-avatar">{email.from[0]}</div>
                    <div className="landing-preview-email-meta">
                      <div className="landing-preview-email-row">
                        <span className="landing-preview-from">{email.from}</span>
                        <span className="landing-preview-time">{email.time}</span>
                      </div>
                      <span className="landing-preview-subj">{email.subj}</span>
                    </div>
                    {email.unread && <div className="landing-preview-unread-dot" />}
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="landing-section-inner">
          <div className="landing-section-header">
            ...
            <p className="landing-section-sub">
              Thoughtfully crafted tools that get out of your way and let you focus on what matters.
            </p>
          </div>
      ...
      <section className="landing-cta">
        ...
        <div className="landing-cta-inner">
          ...
          <p className="landing-cta-sub">
            Join thousands of people who've already discovered a calmer way to email.
          </p>
          <button
            id="cta-signin-btn"
            onClick={handleSignIn}
      ...
      <footer className="landing-footer">
        <div className="landing-footer-inner">
          <div className="landing-logo">
            ...
            <span className="landing-logo-text" style={{ fontSize: '0.9rem' }}>ZenMail</span>
          </div>
          <p className="landing-footer-copy">
            © {new Date().getFullYear()} ZenMail · Built with Next.js · Powered by Resend
          </p>
        </div>
      </footer>
    </div>
